...
def main():
    ...
    sensitivity_a = sensitivity_to_dropout(env, agent_idx=0, outcome_fn=outcome_fn, dropout_rounds=50)
    sensitivity_b = sensitivity_to_dropout(env, agent_idx=1, outcome_fn=outcome_fn, dropout_rounds=50)
